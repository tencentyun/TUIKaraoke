...
import com.tencent.liteav.tuikaraoke.ui.lrc.widget.FloatLyricsView;
...
public class KaraokeRoomBaseActivity extends AppCompatActivity implements KaraokeRoomSeatAdapter.OnItemClickListener,
        ...
        IUpdateLrcDelegate {
    protected static final String TAG = KaraokeRoomBaseActivity.class.getName();
    ...
    public void ktvMusicImplComplete() {
        ...
        mKTVMusicView.setMusicManagerImpl(mKaraokeMusicService);
    }
    ...
    protected void initListener() {
        ...
        mIvAudienceMove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int position = mRvAudienceScrollPosition + UserUtils.dp2px(mContext, 32);
        ...
        mTRTCKaraokeRoom.sendRoomCustomMsg(String.valueOf(TCConstants.IMCMD_GIFT),
                gson.toJson(jsonData), new TRTCKaraokeRoomCallback.ActionCallback() {
                    ...
                    public void onCallback(int code, String msg) {
                        if (code != 0) {
                            Toast.makeText(mContext, R.string.trtckaraoke_toast_sent_message_failure, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void matchQuality(TRTCCloudDef.TRTCQuality trtcQuality, KaraokeRoomSeatEntity entity) {
        ...
        if (oldQulity != entity.getQuality()) {
            mKaraokeRoomSeatAdapter.notifyItemChanged(mKaraokeRoomSeatEntityList.indexOf(entity), KaraokeRoomSeatAdapter.QUALITY);
        }
    }
    ...
    public void onSeatListChange(final List<TRTCKaraokeRoomDef.SeatInfo> seatInfoList) {
        ...
        mKTVMusicView.updateListChange(mKaraokeRoomSeatEntityList);
    }
    ...
    @Override
    public void onMusicProgressUpdate(int musicID, long progress, long total) {
        //收到歌曲进度的回调后,更新歌词显示进度
    ...
    public void onMusicPrepareToPlay(int musicID) {
        ...
        mKaraokeMusicService.prepareToPlay(String.valueOf(musicID));
    }
    ...
    public void onMusicCompletePlaying(int musicID) {
        ...
        mTUIKaraokeAudioManager.setCurrentStatus(TUIKaraokeAudioManager.MUSIC_STOP);
        mKaraokeMusicService.completePlaying(String.valueOf(musicID));
        setLrcPath(null);
    }
    ...
    class LrcAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            if (mLrcView.getLrcStatus() == AbstractLrcView.LRCSTATUS_LRC && mLrcView.getLrcPlayerStatus()
                    != AbstractLrcView.LRCPLAYERSTATUS_PLAY) {
                mLrcView.play(0);
            }
        }
    }
