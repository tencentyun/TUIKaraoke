...
public class AudienceListAdapter extends RecyclerView.Adapter<AudienceListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View           view     = inflater.inflate(R.layout.trtckaraoke_item_audience, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Context context,
            ...
            ImageLoader.loadImage(context, mImgHead, entity.userAvatar, R.drawable.trtckaraoke_ic_head);
        }

        private void initView(@NonNull final View itemView) {
            mImgHead = (CircleImageView) itemView.findViewById(R.id.img_audience_head);
        }
    }
}