...
import com.tencent.liteav.tuikaraoke.ui.gift.imp.RecyclerViewController;
...
public class GiftPanelAdapter extends RecyclerView.Adapter<GiftPanelAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.trtckaraoke_recycle_item_gift_panel, parent, false);
