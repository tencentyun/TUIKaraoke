...
public interface TRTCKaraokeRoomObserver {
    /**
     * 组件出错信息，请务必监听并处理
     */
     ...
     */
    void onSeatListChange(List<TRTCKaraokeRoomDef.SeatInfo> seatInfoList);
     ...
     * 音视频技术指标的实时统计回调
     *
     * @param statistics 统计数据，包括自己本地的统计信息和远端用户的统计信息。
     */
     ...
     * @param musicID 播放时传入的 music ID
     */
    void onMusicPlayCompleted(String musicID);
     ...
     * 更新网络NTP时间回调，
     *
     * @param code    错误码，code 0: 校时成功且偏差在30ms以内；1: 校时成功但偏差可能在30ms以上；-1: 校时失败
     * @param message 错误信息
     */
