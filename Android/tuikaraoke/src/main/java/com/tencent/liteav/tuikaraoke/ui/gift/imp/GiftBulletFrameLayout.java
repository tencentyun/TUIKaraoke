...
import com.tencent.liteav.tuikaraoke.ui.gift.utils.AnimationUtils;
...
public class GiftBulletFrameLayout extends FrameLayout implements Handler.Callback {
    ...
    private void initView() {
        mRootView = mInflater.inflate(R.layout.trtckaraoke_layout_gift_bullet, null);
    ...
    public boolean setGift(GiftInfo gift) {
        ...
        if (!TextUtils.isEmpty(gift.title)) {
            String tip = String.format(mContext.getString(R.string.trtckaraoke_gift_send), gift.title);
