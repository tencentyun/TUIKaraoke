package com.tencent.liteav.tuikaraoke.model.impl.server;
...
public class TRTCKaraokeRoomManager {
    private static final String                 TAG = "TRTCKaraokeRoomManager";
    private static       TRTCKaraokeRoomManager sInstance;
    private              RoomCallback           mRoomCallback;

    public static TRTCKaraokeRoomManager getInstance() {
        if (sInstance == null) {
            synchronized (TRTCKaraokeRoomManager.class) {
                if (sInstance == null) {
                    sInstance = new TRTCKaraokeRoomManager();
                }
            }
        }
        return sInstance;
