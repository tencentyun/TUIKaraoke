...
public class IMManager {
    ...
    public void initIMSDK(Context context) {
        ...
        Log.d(TAG, "initIMSDK: = " + HttpLogicRequest.getInstance().getSdkAppId());
        V2TIMManager.getInstance().initSDK(context, HttpLogicRequest.getInstance().getSdkAppId(), config, new V2TIMSDKListener() {
            @Override
