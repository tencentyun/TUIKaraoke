//
//  TRTCKaraokeAudienceTableViewCell.swift
//  TRTCKaraokeDemo
//
...
import UIKit
import TXAppBasic
class TRTCKaraokeAudienceTableViewCell: UITableViewCell {
...
fileprivate extension String {
    ...
    static let inviteText = karaokeLocalize("Demo.TRTC.LiveRoom.invite")
}
