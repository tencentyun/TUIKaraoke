//
//  TRTCKaraokeAudienceListView.swift
//  TRTCKaraokeDemo
//
...
class TRTCKaraokeAudienceListView: UIView {
    ...
    let tableView: UITableView = {
        ...
        tableView.register(TRTCKaraokeAudienceTableViewCell.self, forCellReuseIdentifier: "TRTCKaraokeAudienceTableViewCell")
...
extension TRTCKaraokeAudienceListView: UITableViewDelegate {
    
}

extension TRTCKaraokeAudienceListView: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return viewModel.memberAudienceList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TRTCKaraokeAudienceTableViewCell", for: indexPath)
        if let audienceCell = cell as? TRTCKaraokeAudienceTableViewCell {
