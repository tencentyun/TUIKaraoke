...
* 歌曲信息回调
*/
public typealias MusicListCallback = (_ list: [KaraokeMusicInfo]) -> ()

/**
* 已选列表回调
*/
public typealias MusicSelectedListCallback = (_ list: [KaraokeMusicModel]) -> ()
...
//////////////////////////////////////////////////////////
    ...
    */
    func ktvGetMusicPage(page: Int, pageSize: Int, callback: @escaping MusicListCallback)
