...
class MusicScoreDialog: UIView {
    ...
    lazy var bgImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "final_score", in: karaokeBundle(), with: nil)
        return imageView
    }()
    
    lazy var closeBtn: UIButton = {
        let btn = UIButton(frame: .zero)
        btn.setTitle(.closeText, for: .normal)
    ...
    lazy var scoreDescLabel: UILabel = {
        ...
        label.text = .finalScoreDescText
        return label
    }()
    
    lazy var singImageView3: UIImageView = {
        let imageView = UIImageView(frame: .zero)
        imageView.image = UIImage(named: "score3", in: karaokeBundle(), with: nil)
        return imageView
    }()
    ...
    func show(songName: String, score: Int32) {
        ...
        pointsLabel.text = .finalScoreText
...
extension String {
    static var closeText: String {
        karaokeLocalize("Demo.TRTC.Salon.close")
    }
    
    static var finalScoreDescText: String {
        karaokeLocalize("Demo.TRTC.Karaoke.finalScoreDesc")
    }
    
    static var finalScoreText: String {
        karaokeLocalize("Demo.TRTC.Karaoke.finalScore")
    }
