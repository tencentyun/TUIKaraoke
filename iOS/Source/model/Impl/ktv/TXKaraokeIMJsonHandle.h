...
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MPREPARE = @"m_prepare";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MCOMPLETE = @"m_complete";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MPLAYMUSIC = @"m_play_music";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MSTOP = @"m_stop";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MLISTCHANGE = @"m_list_change";//歌曲列表发生改变->IM消息标记
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MPICK = @"m_pick";//把歌曲加入->IM消息标记
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MDELETE = @"m_delete";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MTOP = @"m_top";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MNEXT = @"m_next";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MGETLIST = @"m_get_list";
static NSString* gKaraoke_VALUE_CMD_INSTRUCTION_MDELETEALL = @"m_delete_all";
...
+ (NSDictionary<NSString *, NSString *> *)getInitRoomDicWithRoomInfo:(TXKaraokeRoomInfo
 *)roominfo seatInfoList:(NSArray<TXKaraokeSeatInfo *> *)seatInfoList;
