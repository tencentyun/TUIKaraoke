...
#import "TRTCKaraokeRoomObserver.h"
#import "TRTCKaraokeRoomDef.h"

NS_ASSUME_NONNULL_BEGIN

@class TXAudioEffectManager;
@interface TRTCKaraokeRoom : NSObject
 ...
 *
 * - parameter observer 回调接口
 * - note: TRTCKaraokeRoom 中的回调事件，默认是在 Main Queue 中回调给您；如果您需要指定事件回调所在的队列，可使用 {@link TRTCKaraokeRoomObserver#setObserver(observer:)}
 */
- (void)setObserver:(id<TRTCKaraokeRoomObserver>)observer NS_SWIFT_NAME(setObserver(observer:));
 ...
 */
- (void)setObserverQueue:(dispatch_queue_t)queue NS_SWIFT_NAME(setObserverQueue(queue:));
...
- (void)login:(int)sdkAppID
     ...
     callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(login(sdkAppID:userId:userSig:callback:));

/**
 * 退出登录
 */
- (void)logout:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(logout(callback:));
 ...
 */
- (void)setSelfProfile:(NSString *)userName avatarURL:(NSString *)avatarURL callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(setSelfProfile(userName:avatarURL:callback:));

/**
 * 更新NTP网络校时
 */
- (void)updateNetworkTime NS_SWIFT_NAME(updateNetworkTime());
 ...
 */
- (void)createRoom:(int)roomID roomParam:(KaraokeRoomParam *)roomParam callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(createRoom(roomID:roomParam:callback:));
 ...
 */
- (void)destroyRoom:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(destroyRoom(callback:));
 ...
 */
- (void)enterRoom:(int)roomID callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(enterRoom(roomID:callback:));

/**
 * 退出房间
 * - note 房主如果退出房间，退出成功需要调用 destroyRoom 销毁房间。
 * - parameter callback 退出房间是否成功的结果回调
 */
- (void)exitRoom:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(exitRoom(callback:));
 ...
 */
- (void)getRoomInfoList:(NSArray<NSNumber *> *)roomIdList callback:(KaraokeRoomInfoListCallback _Nullable)callback NS_SWIFT_NAME(getRoomInfoList(roomIdList:callback:));
 ...
 */
- (void)enterSeat:(NSInteger)seatIndex callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(enterSeat(seatIndex:callback:));
 ...
 * - parameter callback 操作回调
 */
- (void)leaveSeat:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(leaveSeat(callback:));
 ...
 * - parameter callback     操作回调
 */
- (void)pickSeat:(NSInteger)seatIndex userId:(NSString *)userId callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(pickSeat(seatIndex:userId:callback:));
 ...
 * - parameter callback     操作回调
 */
- (void)kickSeat:(NSInteger)seatIndex callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(kickSeat(seatIndex:callback:));
 ...
 * - parameter callback     操作回调
 */
- (void)muteSeat:(NSInteger)seatIndex isMute:(BOOL)isMute callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(muteSeat(seatIndex:isMute:callback:));
 ...
 * - parameter callback     操作回调
 */
- (void)closeSeat:(NSInteger)seatIndex isClose:(BOOL)isClose callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(closeSeat(seatIndex:isClose:callback:));
 ...
 */
- (void)sendRoomTextMsg:(NSString *)message callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(sendRoomTextMsg(message:callback:));
 ...
 * - parameter callback 发送结果回调
 */
- (void)sendRoomCustomMsg:(NSString *)cmd message:(NSString *)message callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(sendRoomCustomMsg(cmd:message:callback:));
...
- (NSString *)sendInvitation:(NSString *)cmd
                    ...
                    callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(sendInvitation(cmd:userId:content:callback:));
 ...
 */
- (void)acceptInvitation:(NSString *)identifier callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(acceptInvitation(identifier:callback:));
 ...
 * - parameter callback     接受操作的回调
 */
- (void)rejectInvitation:(NSString *)identifier callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(rejectInvitation(identifier:callback:));
 ...
 * - parameter callback     接受操作的回调
 */
- (void)cancelInvitation:(NSString *)identifier callback:(KaraokeCallback _Nullable)callback NS_SWIFT_NAME(cancelInvitation(identifier:callback:));

#pragma mark - 背景音乐特效函数
