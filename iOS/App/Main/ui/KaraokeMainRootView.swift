...
protocol KaraokeMainRootViewDelegate: NSObject {
    func enterRoom(roomId: String)
    func createRoom()
}

class KaraokeMainRootView: UIView {
    ...
    weak var delegate: KaraokeMainRootViewDelegate? = nil
