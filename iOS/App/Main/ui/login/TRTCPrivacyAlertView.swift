...
fileprivate extension String {
    ...
    static let confirmText = TRTCKaraokeLocalize("V2.Live.LinkMicNew.agree")
    static let cancelText = TRTCKaraokeLocalize("V2.Live.LinkMicNew.disagree")
    
    static let agreementText = TRTCKaraokeLocalize("Demo.TRTC.Portal.privatealertdescription")
