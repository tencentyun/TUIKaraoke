...
fileprivate extension String {
    static let registSuccessText = TRTCKaraokeLocalize("Demo.TRTC.Login.registsuccess")
    static let firstLoginText = TRTCKaraokeLocalize("Demo.TRTC.LoginMock.adduserinformationforfirstlogin")
    static let fillInUserNickNameText = TRTCKaraokeLocalize("Demo.TRTC.LoginMock.fillinusernickname")
}
