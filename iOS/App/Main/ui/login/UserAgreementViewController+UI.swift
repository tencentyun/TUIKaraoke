...
extension UserAgreementViewController {
    func setupUI() {
        title = TRTCKaraokeLocalize("V2.Live.LinkMicNew.termsandconditions")
        ...
        agreeBtn.setTitle(TRTCKaraokeLocalize("V2.Live.LinkMicNew.agree"), for: .normal)
        ...
        unAgreeBtn.setTitle(TRTCKaraokeLocalize("V2.Live.LinkMicNew.disagree"), for: .normal)
