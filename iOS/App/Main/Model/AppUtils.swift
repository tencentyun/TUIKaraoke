...
public class AppUtils: NSObject {
    ...
    func alertUserTips(_ vc: UIViewController) {
        ...
        let alertVC = UIAlertController(title:TRTCKaraokeLocalize("LoginNetwork.AppUtils.warmprompt"), message: TRTCKaraokeLocalize("LoginNetwork.AppUtils.tomeettheregulatory"), preferredStyle: UIAlertController.Style.alert)
        let okView = UIAlertAction(title: TRTCKaraokeLocalize("LoginNetwork.AppUtils.determine"), style: UIAlertAction.Style.default, handler: nil)
